...
> All lines of code in this project were written by a human (me or otherwise) in an effort to preserve the authenticity 
> of this repository. If a piece of code looks to be generated by AI, it is purely coincidental. Please contact me 
> for any questions or concerns on this matter.

## Description

A very simple clone of the original Pong game created in 1972 by Atari.
The purpose of this project is to get the fundamentals down of OpenGL and get
basic abstractions written for future OpenGL projects. It is also used for
experimentation in physics, UI, and more.
